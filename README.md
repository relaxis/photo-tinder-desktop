...
|----------|----------|------|
| **Windows** | [Photo.Tinder_1.0.2_x64-setup.exe](https://github.com/relaxis/photo-tinder-desktop/releases/download/v1.0.2/Photo.Tinder_1.0.2_x64-setup.exe) | ~3 MB |
| **Windows (MSI)** | [Photo.Tinder_1.0.2_x64_en-US.msi](https://github.com/relaxis/photo-tinder-desktop/releases/download/v1.0.2/Photo.Tinder_1.0.2_x64_en-US.msi) | ~3 MB |
| **macOS (Apple Silicon)** | [Photo.Tinder_1.0.2_aarch64.dmg](https://github.com/relaxis/photo-tinder-desktop/releases/download/v1.0.2/Photo.Tinder_1.0.2_aarch64.dmg) | ~2 MB |
| **macOS (Intel)** | [Photo.Tinder_1.0.2_x64.dmg](https://github.com/relaxis/photo-tinder-desktop/releases/download/v1.0.2/Photo.Tinder_1.0.2_x64.dmg) | ~2 MB |
| **Linux (AppImage)** | [Photo.Tinder_1.0.2_amd64.AppImage](https://github.com/relaxis/photo-tinder-desktop/releases/download/v1.0.2/Photo.Tinder_1.0.2_amd64.AppImage) | ~73 MB |
| **Linux (Debian/Ubuntu)** | [Photo.Tinder_1.0.2_amd64.deb](https://github.com/relaxis/photo-tinder-desktop/releases/download/v1.0.2/Photo.Tinder_1.0.2_amd64.deb) | ~2.5 MB |
| **Linux (Fedora/RHEL)** | [Photo.Tinder-1.0.2-1.x86_64.rpm](https://github.com/relaxis/photo-tinder-desktop/releases/download/v1.0.2/Photo.Tinder-1.0.2-1.x86_64.rpm) | ~2.5 MB |
...
```bash
sudo dpkg -i ~/Downloads/Photo.Tinder_1.0.2_amd64.deb && sudo apt-get install -f
```

**Fedora/RHEL:**
```bash
sudo rpm -i ~/Downloads/Photo.Tinder-1.0.2-1.x86_64.rpm
```
...
```bash
curl -L https://github.com/relaxis/photo-tinder-desktop/releases/download/v1.0.2/Photo.Tinder_1.0.2_amd64.AppImage -o ~/Photo-Tinder.AppImage && chmod +x ~/Photo-Tinder.AppImage && ~/Photo-Tinder.AppImage
```

**Or if already downloaded:**
```bash
chmod +x ~/Downloads/Photo.Tinder_1.0.2_amd64.AppImage && ~/Downloads/Photo.Tinder_1.0.2_amd64.AppImage
```
